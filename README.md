...
```javascript
import seq2slice from 'https://cdn.jsdelivr.net/gh/stdlib-js/slice-base-seq2slice@v0.2.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/slice-base-seq2slice/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/slice-base-seq2slice/actions/workflows/test.yml?query=branch:v0.2.1
